...
class DraftTemplateTest {
    ...
    private static Repo repo() {
        Repo repo = new Repo();
        repo.setFullName("Ae-Ti/Devronicle");
        return repo;
    }
    ...
    private static VscodeSession session() {
        ...
        s.setRemoteUrl("https://github.com/Ae-Ti/Devronicle.git");
    ...
    void groupsByRepo() {
        ...
        assertThat(md)
                ...
                .contains("## Ae-Ti/Devronicle")
                .contains("### 완료한 작업")
                .contains("### 진행 중 / 미커밋")
                .contains("### 계획 / TODO")
                .contains("## 메모");
        assertThat(md.indexOf("## Ae-Ti/Devronicle")).isLessThan(md.indexOf("### 완료한 작업"));
    ...
    void oneSectionPerRepo() {
        ...
        assertThat(md).contains("## Ae-Ti/CodeAtlas").contains("## Ae-Ti/Devronicle");
        // 이름 순이라 날마다 순서가 흔들리지 않는다.
        assertThat(md.indexOf("## Ae-Ti/CodeAtlas")).isLessThan(md.indexOf("## Ae-Ti/Devronicle"));
        assertThat(md.split("## 메모", -1)).hasSize(2);
        assertThat(md.indexOf("## 메모")).isGreaterThan(md.indexOf("## Ae-Ti/Devronicle"));
    }
