...
class EmployeeAccountServiceTest {
    ...
    void setUp() {
        ...
        directoryClient = mock(DirectoryClient.class);
        when(directoryClient.employees(anyLong()))
                .thenReturn(List.of(new DirectoryClient.Employee(9998L, "배태일")));
        ...
        service = new EmployeeAccountService(userRepository, directoryClient, properties);
    }
