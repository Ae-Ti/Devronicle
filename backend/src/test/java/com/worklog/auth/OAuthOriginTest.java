...
class OAuthOriginTest {
    ...
    @ValueSource(strings = {
        ...
        "192.168.0.10.evil.com", // 앞부분만 흉내 낸 주소
        "1.2.3.4",
    })
    ...
    @ParameterizedTest
    @ValueSource(strings = {
        "http://192.168.0.10:5173", "http://192.168.0.11:5173", "http://localhost:5173",
    })
    ...
    @ParameterizedTest
    @ValueSource(strings = {
        "http://192.168.0.10.evil.com", "http://10.evil.com", "https://evil.com", "null", "",
    })
