...
class RemoteUrlParserTest {
    ...
    @CsvSource({
        "https://github.com/devronicle/attendance.git, devronicle/attendance",
        "https://github.com/devronicle/attendance,     devronicle/attendance",
        "https://github.com/devronicle/attendance/,    devronicle/attendance",
        "git@github.com:devronicle/attendance.git,     devronicle/attendance",
        "ssh://git@github.com/devronicle/web.git, devronicle/web",
        "https://github.com/Ae-Ti/Devronicle.git, Ae-Ti/Devronicle",
        "https://github.com/devronicle/my.repo.name.git, devronicle/my.repo.name",
    })
