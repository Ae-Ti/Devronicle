...
public class DirectoryProperties {
     ...
     *
     * <p>{@code 9999:김서준,9998:배태일} 형식. 사내망 밖에서 회원 흐름을 시험하려고 둔다.
     * {@link #isConfigured()} 가 true 면(진짜 API 가 있으면) 이 값은 쓰이지 않는다.
     * 사원 명부 연동이 끝나면 설정과 함께 지운다.
     */
