...
public class PeopleDirectoryService {
    ...
    public PeopleDirectoryResponse directory() {
        ...
        if (companySeq != null || !directoryClient.isConfigured()) {
            for (DirectoryClient.Employee e : directoryClient.employees(companySeq == null ? 0L : companySeq)) {
        ...
        return new PeopleDirectoryResponse(
                directoryClient.isConfigured(), companySeq, employees, unlinked, unclaimed());
    }
