 ...
 * <p>세 갈래를 한 화면에 모은다.
 * <ul>
 *   <li>{@code employees} — 사내 회원(사원 명부) 사원. 우리 계정과 이어졌는지 보여 준다
 *   <li>{@code unlinkedAccounts} — 로그인은 했지만 사원과 잇지 않은 계정
 *   <li>{@code unclaimedContributors} — 커밋은 있는데 로그인한 적이 없는 GitHub 계정 (BACKLOG §3-4)
 * </ul>
 *
 * @param directoryConfigured 사원 명부 API 설정 여부. false 면 employees 가 비고 화면이 안내를 띄운다
 */
public record PeopleDirectoryResponse(
        boolean directoryConfigured,
        Long companySeq,
