 ...
 *
 * <p>사람마다 접속 주소가 다르다 — 나는 {@code 192.168.0.10}, 친구는 {@code ...218}. 그래서
...
public final class InternalNetwork {
    ...
    /**
     * {@code http://192.168.0.10:5173} 같은 Origin 헤더 값이 사내망에서 온 것인지.
     *
     ...
     *
     * <p>앞자리만 견주면 {@code 192.168.0.10.evil.com} 같은 주소가 통과한다 — 남이 그 도메인을
